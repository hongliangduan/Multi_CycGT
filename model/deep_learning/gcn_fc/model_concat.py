...
def main():
    for num in range(1, 11):
        ...
        for epoch in range(1, 201):
            ...
            torch.save(gcn_net, './model/gcn_fc/{}/gcn/{}_gcn.pt'.format(num, epoch))
            torch.save(model_tgcn, './model/gcn_fc/{}/g_fc/{}_g_fc.pt'.format(num, epoch))
            ...
            pd.DataFrame(tt).to_csv('./pred_data/gcn_fc/{}/test/experiment_{}_predicted_test_values.csv'.format(num, epoch),
                                    index=False)
            ...
            pd.DataFrame(tt).to_csv('./pred_data/gcn_fc/{}/val/experiment_{}_predicted_valid_values.csv'.format(num, epoch),
                                    index=False)
